...
static BasicByteOption optionTitleBar(CFGKEY_TITLE_BAR, 1, Config::envIsIOS);
...
static struct OptionAspectRatio : public Option<OptionMethodVar<uint32>, uint8>
{
	...
	bool writeToIO(Io *io)
	{
		...
		uint x = systemAspectRatioX, y = systemAspectRatioY;
		if(val == 1)
		{
			x = 1; y = 1;
		}
...
static Option<OptionMethodRelPointerDecel> optionRelPointerDecel(CFGKEY_REL_POINTER_DECEL, optionRelPointerDecelMed,
		!Config::envIsAndroid);
...
static Option2DOrigin optionTouchCtrlMenuPos(CFGKEY_TOUCH_CONTROL_MENU_POS, Config::ENV == Config::WEBOS ? NULL2DO : RT2DO);
...
static struct OptionRecentGames : public OptionBase
{
	...
	extern bool glSyncHackEnabled, glSyncHackBlacklisted;
	...
	static Option<OptionMethodFunc<uint, Base::ios_iCadeActive, Base::ios_setICadeActive>, uint8> optionICade(CFGKEY_ICADE, 0);
#endif
